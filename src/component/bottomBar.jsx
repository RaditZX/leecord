    ...
    return(
        <div className="bottom-bar">
            <div className="bottom-bar-profile">
                <div className="bottom-bar-profile-icon">
                    <img src="https://th.bing.com/th/id/OIP.WgS-HnL0M5Ttick5QBQz5wHaHa?pid=ImgDet&rs=1" alt="" />
                </div>
                <div className="bottom-bar-profile-name">
                    <p>Kazehaya</p>
                </div>
            </div>
            <div className="bottom-bar-icon">
                <div className="bottom-bar-icon-mic">
                ...
                <div className="bottom-bar-icon-headset">
                ...
                <div className="bottom-bar-icon-setting">
